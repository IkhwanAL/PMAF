...
const InfoModal = ({ setModal, modal }: ModalProps): ReactElement => {
	return (
		<>
			...
			<div
				className={`flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl absolute`}
			>
				...
				<div className="flex flex-col px-6 py-5 bg-gray-50">
					...
					<div className="flex items-center mt-5 mb-3 space-x-4">
						<input
							...
							name="check1"
						/>
						<label className="inline-flex font-semibold text-gray-400">
							Add a crew
						</label>
						<br />
						<input
							...
							checked
						/>
						<label className="inline-flex font-semibold text-blue-500">
